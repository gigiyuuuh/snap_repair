...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1471848803ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="169">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_enrollmentsystem&table=enrollment+system">`db_enrollmentsystem`.`enrollment system`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_snaprepair&table=tbl_inventory">`db_snaprepair`.`tbl_inventory`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_snaprepair&table=tbl_damagereports">`db_snaprepair`.`tbl_damagereports`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_snaprepair&table=tbl_assets">`db_snaprepair`.`tbl_assets`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_snaprepair&table=tbl_users">`db_snaprepair`.`tbl_users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_snaprepair&table=tbl_logs">`db_snaprepair`.`tbl_logs`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_snaprepair&table=tbl_components">`db_snaprepair`.`tbl_components`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_snaprepair&table=tbl_department">`db_snaprepair`.`tbl_department`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_enrollmentsystem&table=Enrollment+System">`db_enrollmentsystem`.`Enrollment System`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=techoyaki&table=inventory">`techoyaki`.`inventory`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="2e582a7c71413f744949324e2f223234">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="169"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
